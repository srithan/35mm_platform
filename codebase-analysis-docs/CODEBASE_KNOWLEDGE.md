...
Generated from a direct repository inspection on 2026-06-23. Last refreshed for full content moderation backend on 2026-07-11, mobile shell navigation behavior on 2026-07-17, React Native email verification on 2026-07-24, NSFW classification plus web presentation on 2026-07-25, the signed-out web landing redesign on 2026-09-03, React Native mixed posts/comments on 2026-09-06, the React Native authenticated shell plus notification/bookmark/list/profile surfaces on 2026-09-13, React Native password recovery on 2026-09-20, and the retained SwiftUI plus React Native auth-flow refresh on 2026-09-20.
...
- `ThirtyFiveMM/Core/Auth/AuthManager.swift` and `ThirtyFiveMM/App/RootView.swift`: Clerk session restoration, local wordmark splash during bootstrap, API bootstrap/onboarding gate, signup DOB persistence through the existing owner-only profile update path, and retry/sign-out recovery when Clerk is signed in but app bootstrap is unavailable.
