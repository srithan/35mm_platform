...
export function ChatList({
  ...
  const activeId = selectedId ?? (pathname.replace("/chat/", "").split("/")[0] || null);
          ...
          filtered.map(function (chat) {
            ...
            return (
              ...
              >
                <div
                  className={cn(
                    "rounded-full flex-shrink-0 flex items-center justify-center font-semibold w-11 h-11 text-[15px] shadow-sm ring-1 ring-black/[0.04]",
