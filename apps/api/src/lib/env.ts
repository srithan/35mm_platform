...
export function loadEnv() {
  ...
  return {
    ...
    BUNNY_STREAM_POST_COLLECTION_ID: process.env.BUNNY_STREAM_POST_COLLECTION_ID ?? "",
    BUNNY_STREAM_FILM_COLLECTION_ID: process.env.BUNNY_STREAM_FILM_COLLECTION_ID ?? "",
