...
export function loadWorkerEnv() {
  return {
    ...
    MEILISEARCH_TASK_TIMEOUT_MS: Number(
      process.env.MEILISEARCH_TASK_TIMEOUT_MS ?? "30000"
    ),
    ...
    MODERATION_AUTO_HIDE_THRESHOLD: Number(process.env.MODERATION_AUTO_HIDE_THRESHOLD ?? "5"),
    MODERATION_AUTO_HIDE_WINDOW_MINUTES: Number(process.env.MODERATION_AUTO_HIDE_WINDOW_MINUTES ?? "60"),
    MODERATION_AUTO_HIDE_TRUSTED_FOLLOWER_THRESHOLD: Number(process.env.MODERATION_AUTO_HIDE_TRUSTED_FOLLOWER_THRESHOLD ?? "50000"),
    MODERATION_NOTIFICATION_BATCH_SIZE: Number(process.env.MODERATION_NOTIFICATION_BATCH_SIZE ?? "500"),
    MODERATION_NOTIFICATION_OUTBOX_INTERVAL_SECONDS: Number(process.env.MODERATION_NOTIFICATION_OUTBOX_INTERVAL_SECONDS ?? "30"),
