...
enum ProfileDesign {
  ...
  static let coverAspectRatio = 2.35
  static let scrollCoordinateSpace = "profile-scroll"
  static let contentCoordinateSpace = "profile-content"
  static let pullRefreshThreshold: CGFloat = 72.0
  static let coverBackButtonVisibleSize = 36.0
  static let coverBackButtonTapSize = 44.0
  static let coverBackButtonTopPadding = 18.0
